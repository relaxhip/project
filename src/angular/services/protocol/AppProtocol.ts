...
export class AppProtocol {
    ...
    private checkSetSystemFunction(fname:string){
        var fnlist =['abctest', 'InitDevice', 'ChangeWindowSize','SendKey','ExportProfile','QuitApp'];
    ...
    private checkSetDeviceFunction(fname:string){
        var fnlist =['SetCommand','SetMacroKey','GetKeyMatrix','SetKeyMatrix','APMode','RunApplication','LightBarMode','GetProfieAndFirmwareVer','GetDefaultKeyMatrix','SetProfie','GetProfileInfo'];
        return fnlist.lastIndexOf(fname) >=0;
    }
